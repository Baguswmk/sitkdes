        ...
        {Object.entries(groupedSettings).map(([category, items]) => (
          ...
          >
            <div
              style={{
                background:
                  "linear-gradient(90deg, rgba(214,178,90,.15), transparent)",
                padding: "16px 24px",
            ...
            <div style={{ padding: "0 24px" }}>
              {items.map((item, index) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="max-[600px]:flex-col max-[600px]:items-start max-[600px]:gap-4"
                    style={{
                      display: "flex",
                      justifyContent: "space-between",
                      alignItems: "center",
                    ...
                    >
                      {valueType === "boolean" ? (
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleValueChange(item.id, Number(e.target.value))
                          }
